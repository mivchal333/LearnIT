...
INSERT INTO PUBLIC.USER_ATTEMPT (ID, END_DATE, START_DATE, SHOWED_QUESTION_ID, USER_ACCOUNT_EMAIL)
VALUES ('fbc02259-c608-493d-b13e-592d9314f13f', null, '2021-11-10 20:29:07.091371', null, 'admin@admin.com');
INSERT INTO PUBLIC.USER_ATTEMPT (ID, END_DATE, START_DATE, SHOWED_QUESTION_ID, USER_ACCOUNT_EMAIL)
VALUES ('cb63e7cc-c68e-4bf1-b0b0-29da8e55f060', null, '2021-11-25 01:08:09.796025', null, 'admin@admin.com');
INSERT INTO PUBLIC.USER_ATTEMPT (ID, END_DATE, START_DATE, SHOWED_QUESTION_ID, USER_ACCOUNT_EMAIL)
VALUES ('dabd4a16-cf96-4e48-9a3e-4b10e88ea74f', null, '2021-11-25 01:08:24.204231', null, 'admin@admin.com');
INSERT INTO PUBLIC.USER_ATTEMPT (ID, END_DATE, START_DATE, SHOWED_QUESTION_ID, USER_ACCOUNT_EMAIL)
VALUES ('807c984a-75f1-4b6d-b57a-5d77fa6d2e4c', null, '2021-11-25 01:08:36.613885', null, 'admin@admin.com');

INSERT INTO PUBLIC.TECHNOLOGY_USER_ATTEMPT (TECHNOLOGY_ID, USER_ATTEMPT_ID)
VALUES (1, 'cb63e7cc-c68e-4bf1-b0b0-29da8e55f060');
INSERT INTO PUBLIC.TECHNOLOGY_USER_ATTEMPT (TECHNOLOGY_ID, USER_ATTEMPT_ID)
VALUES (1, 'dabd4a16-cf96-4e48-9a3e-4b10e88ea74f');
INSERT INTO PUBLIC.TECHNOLOGY_USER_ATTEMPT (TECHNOLOGY_ID, USER_ATTEMPT_ID)
VALUES (2, 'cb63e7cc-c68e-4bf1-b0b0-29da8e55f060');
INSERT INTO PUBLIC.TECHNOLOGY_USER_ATTEMPT (TECHNOLOGY_ID, USER_ATTEMPT_ID)
VALUES (2, 'dabd4a16-cf96-4e48-9a3e-4b10e88ea74f');
INSERT INTO PUBLIC.TECHNOLOGY_USER_ATTEMPT (TECHNOLOGY_ID, USER_ATTEMPT_ID)
VALUES (2, '807c984a-75f1-4b6d-b57a-5d77fa6d2e4c');

INSERT INTO PUBLIC.HISTORY_ENTRY (ID, ANSWER_RESULT, DATE, QUESTION_ID, USER_ATTEMPT_ID)
VALUES (1, true, '2021-11-10 20:30:02.092545', 1, 'cb63e7cc-c68e-4bf1-b0b0-29da8e55f060');
INSERT INTO PUBLIC.HISTORY_ENTRY (ID, ANSWER_RESULT, DATE, QUESTION_ID, USER_ATTEMPT_ID)
VALUES (2, false, '2021-11-10 20:35:31.947413', 1, 'cb63e7cc-c68e-4bf1-b0b0-29da8e55f060');
INSERT INTO PUBLIC.HISTORY_ENTRY (ID, ANSWER_RESULT, DATE, QUESTION_ID, USER_ATTEMPT_ID)
VALUES (3, false, '2021-11-10 20:58:21.997822', 1, 'cb63e7cc-c68e-4bf1-b0b0-29da8e55f060');
INSERT INTO PUBLIC.HISTORY_ENTRY (ID, ANSWER_RESULT, DATE, QUESTION_ID, USER_ATTEMPT_ID)
VALUES (4, false, '2021-11-25 01:11:05.235670', 4, 'cb63e7cc-c68e-4bf1-b0b0-29da8e55f060');
INSERT INTO PUBLIC.HISTORY_ENTRY (ID, ANSWER_RESULT, DATE, QUESTION_ID, USER_ATTEMPT_ID)
VALUES (5, false, '2021-11-25 01:11:07.175201', 1, 'cb63e7cc-c68e-4bf1-b0b0-29da8e55f060');
INSERT INTO PUBLIC.HISTORY_ENTRY (ID, ANSWER_RESULT, DATE, QUESTION_ID, USER_ATTEMPT_ID)
VALUES (6, false, '2021-11-25 01:11:08.655640', 3, 'cb63e7cc-c68e-4bf1-b0b0-29da8e55f060');
